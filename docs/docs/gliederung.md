...
3.1 Dataset: MIMIC-IV Heart Failure Cohort and Target Definition  
...
4.4 Feature Analysis: Confounders, True Drivers, and Model Disagreement  
...
6.3 Future Work: Scaling to Richer Feature Spaces and Larger Cohorts